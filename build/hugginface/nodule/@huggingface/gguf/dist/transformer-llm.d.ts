...
export declare const LLM_ARCHITECTURES: readonly ["llama", "falcon", "grok", "gpt2", "gptj", "gptneox", "mpt", "baichuan", "starcoder", "refact", "bert", "nomic-bert", "jina-bert-v2", "bloom", "stablelm", "qwen", "qwen2", "qwen2moe", "phi2", "phi3", "plamo", "codeshell", "orion", "internlm2", "minicpm", "gemma", "gemma2", "starcoder2", "mamba", "xverse", "command-r", "dbrx", "olmo", "openelm", "arctic", "deepseek2", "chatglm", "bitnet", "t5", "t5encoder", "jais"];
...
export type TransformerLLM = ArchLlama | ArchFalcon | ArchGrok | ArchGpt2 | ArchGptj | ArchGptneox | ArchMpt | ArchBaichuan | ArchStarcoder | ArchRefact | ArchBert | ArchNomicBert | ArchJinaBertV2 | ArchBloom | ArchStablelm | ArchQwen | ArchQwen2 | ArchQwen2moe | ArchPhi2 | ArchPhi3 | ArchPlamo | ArchCodeshell | ArchOrion | ArchInternlm2 | ArchMinicpm | ArchGemma | ArchGemma2 | ArchStarcoder2 | ArchMamba | ArchXverse | ArchCommandR | ArchDbrx | ArchOlmo | ArchOpenelm | ArchArctic | ArchDeepseek2 | ArchChatglm | ArchBitnet | ArchT5 | ArchT5encoder | ArchJais;
export {};
