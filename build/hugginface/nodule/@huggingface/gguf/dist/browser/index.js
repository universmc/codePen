...
function parseGGUFQuantLabel(fname) {
  var _a;
  const quantLabel = (_a = fname.toUpperCase().match(GGUF_QUANT_RE_GLOBAL)) == null ? void 0 : _a.at(-1);
  return quantLabel;
}
...
async function gguf(uri, params) {
  ...
  if (params == null ? void 0 : params.computeParametersCount) {
...
exports.GGMLFileQuantizationType = GGMLFileQuantizationType; exports.GGMLQuantizationType = GGMLQuantizationType; exports.GGUFValueType = GGUFValueType; exports.GGUF_QUANT_DESCRIPTIONS = GGUF_QUANT_DESCRIPTIONS; exports.GGUF_QUANT_RE = GGUF_QUANT_RE; exports.GGUF_QUANT_RE_GLOBAL = GGUF_QUANT_RE_GLOBAL; exports.RE_GGUF_FILE = RE_GGUF_FILE; exports.RE_GGUF_SHARD_FILE = RE_GGUF_SHARD_FILE; exports.gguf = gguf; exports.ggufAllShards = ggufAllShards; exports.parseGGUFQuantLabel = parseGGUFQuantLabel; exports.parseGgufShardFilename = parseGgufShardFilename;
