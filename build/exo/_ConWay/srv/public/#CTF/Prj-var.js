function generatePresentation(userName, project, cryptoName, modelName, smartContract, foundationYear) {
    return `
    Bienvenue, je suis un algorithme d'auto-motivation auto replicable, une IA spécialisée dans la recherche stratégique democratique sur le Web3.0. Je travaille en collaboration avec les ${userName} sur le projet ${project}.
