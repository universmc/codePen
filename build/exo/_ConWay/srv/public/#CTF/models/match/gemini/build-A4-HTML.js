...
async function main() {
    ...
    groq.chat.completions.create({
        ...
        messages: [
            ...
            {
                role: "user",
                content: "ta réponse doit intégralement être rédigé au format HTML en respectant les normes du Web sémantique W3C"
            },
            {
                role: "assistant",
                content: "très bien nous allons donc commencer par la page d'accueil pour le site _univers-mc_ avec un carrousel 3 cardes et footer (bc by mc)bootstrap avec des images sur le theme de l'art #crypto $graphique"
            }, 
