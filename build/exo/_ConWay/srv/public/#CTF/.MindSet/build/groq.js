...
const subject = process.argv[2] || 'BITCOIN'; //  Obtenir le sujet via l'argument de ligne de commande
...
async function main() {
  for (const subject of subjects) {
    try {
      ...
      const outputFilePath = `groq_${subject}_` + new Date().toISOString().replace(/[-:TZ]/g, "") + ".md";
