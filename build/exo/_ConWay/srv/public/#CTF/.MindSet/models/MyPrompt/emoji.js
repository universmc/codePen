...
async function main() {
  const chatCompletion = await groq.chat.completions.create({
    messages: [
    { role: 'system', content: "Introduction Prompt --engine >  🎯📝 Table des matière, 🚀 Introduction, 🛠️ Installation, ⚙️ Utilisation,📚 Paramètre,📦 Dépendance, 🧑‍💻 Exemple de Code, 📄 Licence, 🚀 Introduction"}
