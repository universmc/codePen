...
async function main() {
    groq.chat.completions.create({
        ...
        const chtmlContent = chatCompletion.choices[0]?.message?.content;
        const outputFilePath = "output/exemple_" + new Date().toISOString().replace(/[-:TZ]/g, "") + ".html";
        fs.writeFileSync(outputFilePath, chtmlContent);
