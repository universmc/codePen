...
async function main() {
    groq.chat.completions.create({
        ...
        const endpointContent = chatCompletion.choices[0]?.message?.content;
        const outputFilePath = "exemple_" + new Date().toISOString().replace(/[-:TZ]/g, "") + ".md";
        fs.writeFileSync(outputFilePath, endpointContent);
