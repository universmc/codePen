...
async function main() {
    groq.chat.completions.create({
        ...
        const bitmapContent = chatCompletion.choices[0]?.message?.content;
        const outputFilePath = "exemple_" + new Date().toISOString().replace(/[-:TZ]/g, "") + ".bitmap";
        fs.writeFileSync(outputFilePath, bitmapContent);
