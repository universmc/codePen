...
async function main() {
    groq.chat.completions.create({
        ...
        const drawioContent = chatCompletion.choices[0]?.message?.content;
        const outputFilePath = "exemple_" + new Date().toISOString().replace(/[-:TZ]/g, "") + ".drawio";
        fs.writeFileSync(outputFilePath, drawioContent);
