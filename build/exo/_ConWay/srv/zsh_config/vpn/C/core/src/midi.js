...
async function main() {
    groq.chat.completions.create({
        ...
        const midiContent = chatCompletion.choices[0]?.message?.content;
        const outputFilePath = "exemple_" + new Date().toISOString().replace(/[-:TZ]/g, "") + ".midi";
        fs.writeFileSync(outputFilePath, midiContent);
