...
server.listen(5001, () => {
  console.log('Serveur Express démarré sur http://localhost:5314');
});
...
function mainWindow() {
  const win = new BrowserWindow({
    ...
    webPreferences: {
      ...
      preload: path.join(__dirname, 'models/agents/agents.js'), // Charge le script de préchargement
