...
async function main(
  ...
  const contexte = "selon Albert Einstein sur les équations Métaphysique et la cuisine des Quanta";

  const PromptRole = await phraseEinstein(sujet, verbe, complement, contexte);
