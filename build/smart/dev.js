...
function generatePrompt(subject, params) {
  return `Crée un guide détaillé pour ${params.level} expliquant comment générer un revenu passif de ${params.goal} par mois en utilisant ${subject} et Gemini, avec un focus particulier sur le ${params.focusArea}. Couvre les aspects suivants :
    * Identifier les niches de marché liées à ${params.focusArea}
    * Créer des produits ou services numériques qui s'alignent avec ${params.focusArea}
    * Mettre en place une stratégie de marketing adaptée à ${params.focusArea}
    * Gérer le bilan comptable, en particulier les ${params.focusArea}
    * Évaluer les risques et les opportunités spécifiques à ${params.focusArea}`;
}
